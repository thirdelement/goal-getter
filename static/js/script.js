$(document).ready(function () {
  ...
  //Credit: https://stackoverflow.com/questions/32829776/setting-custom-html5-validity-message-property-ignores-pattern-regex
  $('textarea, input').on('input', function () {
    $(this).get(0).reportValidity();
  });

  //Check add_goal form for validity and display message when click submit.  
  //Credit: https://stackoverflow.com/questions/45789010/how-to-use-html-form-checkvalidity/45789752
